...
import { getAllThoughts, getThoughtsById, createThought, deleteThought, updateThoughtsById, createReaction, deleteReaction, } from '../../controllers/thoughtController.js';
const router = Router();
